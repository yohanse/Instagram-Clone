...
SECRET_KEY = 'django-insecure-+gt^y+)stylg#s$-fb)^5e&g0cxk)sd!$m7m6os1-!^ukl4gqp'
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.0.106', '0.0.0.0', '192.168.57.112', '192.168.43.57']
